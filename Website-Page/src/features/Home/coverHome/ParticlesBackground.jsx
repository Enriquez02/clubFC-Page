  ...
  <div className="relative h-screen w-full overflow-hidden">
    ...
    <div className="relative flex flex-col lg:flex-row justify-center items-center pl-22 pr-15 gap-2 h-full w-full text-center ">
      <img
        src={barcaBackground}
        alt="Descripción"
        className="img-fluid-width img-fluid-height hidden md:block animate-[iluminacion-logo_3s_infinite]"
      />

      <h1
        className="font-extrabold uppercase select-none text-white text-fluid lg:overflow-hidden"
        style={{
          backgroundImage: `url(${lettersBarca})`,
